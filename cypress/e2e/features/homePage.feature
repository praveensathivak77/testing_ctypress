Feature: Cubera Homepage Navigation and Contact Form
  ...
  Scenario: Visit each main footer menu link, verify content, and return home
    ...
    And I click and verify all main footer menu links sequentially

  
  Scenario: Visit each footer quick link, verify title and content, then return home
    Given I open the Cubera homepage
    When I scroll to the bottom of the page 2
    And I click, verify, and return for all footer menu links with assertions